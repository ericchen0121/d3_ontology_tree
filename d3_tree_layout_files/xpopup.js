...
function xpopup(p) {
	...
	if (p.modal) {
		...
		modalw.setAttribute("style", "border:0 none;display:block;height:100%;left:0;margin:0;padding:0;position:absolute;top:0;width:100%;z-index:99999;background-color:rgba(0,0,0,0);");
